    ...
    >
      {showRules ? (
        ...
        <>
          ...
          {/* GitHub link */}
          <a
            href="https://github.com/PascalAmah/wildcard"
            target="_blank"
            rel="noopener noreferrer"
            className="fixed bottom-5 right-5 flex items-center gap-1.5 text-[12px] text-[var(--ink-dim)] hover:text-[var(--ink)] transition-colors duration-200 no-underline"
          >
